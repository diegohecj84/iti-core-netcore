...
namespace Ejercicio1.Persistence.EntityFramework
{
    public class ITICoreTemplateDbContext : ITIDbContext
    {
        ...
        public ITICoreTemplateDbContext(DbContextOptions options, IApplicationContext applicationContext, IUserSession userSession) : base(options, applicationContext, userSession)
        {
