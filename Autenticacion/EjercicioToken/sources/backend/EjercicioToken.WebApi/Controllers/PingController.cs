...
namespace EjercicioToken.WebApi.Controllers
{
    /// <summary>
    ...
    public class PingController : ControllerBase
    {
        ...
        public string Get()
        {
            ...
            var phoneNumber = this.PrincipalAccessor.Principal.FindFirst("PhoneNumber").Value;

            return string.Format("Ok : {0} ({1}) - {2}", userName, email, phoneNumber);
        }
    }
}
